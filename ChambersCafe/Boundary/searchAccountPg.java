...
public class searchAccountPg extends javax.swing.JFrame {
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel1)
                                        .addComponent(searchIDTF, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_searchButtonActionPerformed
        ...
        displayMsg(accountFound);
    }// GEN-LAST:event_searchButtonActionPerformed

    private void displayMsg(String x) {
        if (x.isEmpty()) {
            displayTextArea.setText("There is no user account that matches the search");

        } else {
            displayTextArea.append(x);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchAccountPg.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
