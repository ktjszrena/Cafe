...
public class staffSearchDay extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        slotsResultLabel = new javax.swing.JLabel();
    ...
    private void displayMsg(String x) {
        if (x.isEmpty()) {
            slotsResultLabel.setText("No match found: There are no work slots that match the search");
        } else {
            slotsResultLabel.setText(x);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(staffSearchDay.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new staffSearchDay().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel slotsResultLabel;
