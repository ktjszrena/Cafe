...
public class managerViewBidsPg extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(bidComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 225,
                        ...
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(33, 33, 33)
                                                .addComponent(messageLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 387,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 34,
                                        Short.MAX_VALUE)
                                .addComponent(messageLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 12,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(bidComboBox, javax.swing.GroupLayout.PREFERRED_SIZE,
    ...
    private void approveButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_approveButtonActionPerformed
        ...
        display(isUpdated, updateStatus);

    }

    private void display(boolean t, int x) {
        if (x == 1) {
            if (t) {
                messageLabel.setText("Bid: " + bidComboBox.getSelectedItem() + " has been approved.");
            } else {
    ...
    private void rejectButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_rejectButtonActionPerformed
        ...
        display(isUpdated, rejectStatus);
    ...
    private void display(ArrayList<String> x){
        if(x.isEmpty()){
            displayTextArea.setText("There is no bids")
        }
        else{
            for (int i = 0; i < x.size(); i++) {
                displayTextArea.append(x.get(i) + "\n");
                bidComboBox.addItem(x.get(i));
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(managerViewBidsPg.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
