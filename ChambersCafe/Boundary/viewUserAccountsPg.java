 ...
 * @author yuanc
 */
public class viewUserAccountsPg extends javax.swing.JFrame {

    /**
     * Creates new form viewUserAccountsPg
     */
    ...
    public void viewAllButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        displayArray(userAccountDetails);

    }

    private void displayArray(ArrayList<String> userAccountDetails) {
        if (userAccountDetails.isEmpty()) {
            displayTextArea.setText("There is no user accounts recorded");
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewUserAccountsPg.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewUserAccountsPg().setVisible(true);
            }
        });
    }
