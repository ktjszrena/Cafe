...
public class updateProfilePg extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        profileTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Cafe Staff", "Cafe Manager", "Cafe Owner", "System Admin" }));

        jLabel1.setText("Profile Type:");

        jLabel2.setText("Profile Permission:");

        permComboBox.setModel(
                new javax.swing.DefaultComboBoxModel<>(new String[] { "staff", "owner", "manager", "sysadm" }));
                                                ...
                                                .addGroup(layout
                                                        ...
                                                        .addGroup(layout.createSequentialGroup()
                                                                ...
                                                                .addGroup(layout.createParallelGroup(
                                                                        ...
                                                                        .addComponent(profileTypeComboBox,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                        .addComponent(permComboBox,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)))
                                                        .addGroup(layout.createSequentialGroup()
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(profileTypeComboBox, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel1))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel2)
                                        .addComponent(permComboBox, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void modifyButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_modifyButtonActionPerformed
        ...
        boolean isUpdated = uupC.updateUserProfile(profileTypeComboBox.getSelectedItem().toString(),
                displayTextArea.getText(),
                permComboBox.getSelectedItem().toString());
        displayMSg(isUpdated);
        // update here
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateProfilePg.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
