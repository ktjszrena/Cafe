 ...
 * @author yuanc
 */
public class viewUserProfilePg extends javax.swing.JFrame {

    /**
     * Creates new form viewUserProfilePg
     */
    public viewUserProfilePg() {
        initComponents();
    ...
    private void initComponents() {
        ...
        viewProfileButton.setText("View All");
    ...
    private void viewProfileButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_viewProfileButtonActionPerformed
        ...
        displayArray(userProfileDetails);

    }// GEN-LAST:event_viewProfileButtonActionPerformed

    private void displayArray(ArrayList<String> x) {
        if (x.isEmpty()) {
            displayTextArea.setText("There is no user profile recorded");
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewUserProfilePg.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewUserProfilePg().setVisible(true);
            }
        });
    }
