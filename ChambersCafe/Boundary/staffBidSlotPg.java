...
public class staffBidSlotPg extends javax.swing.JFrame {
    ...
    private void applyButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_applyButtonActionPerformed
        ...
        displayValidationMsg(validateBid);

    }// GEN-LAST:event_applyButtonActionPerformed

    private void displayValidationMsg(boolean t) {
        if (t) {
            messageLabel.setText(slotsComboBox.getSelectedItem() + " is applied successfully.");
        } else {
            messageLabel.setText("Not successful.");
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(staffBidSlotPg.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
