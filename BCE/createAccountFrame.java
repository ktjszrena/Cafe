...
public class createAccountFrame extends javax.swing.JFrame {
    ...
    public String createAccountController(){
        ...
        c.createUserAccountS(newUsernameTF.getText(), Integer.parseInt(userIDTF.getText()), newPasswordTF.getText(), dobTF.getText(),
                addressTF.getText(), employeeTypeCB.getSelectedItem().toString(), positionCB.getSelectedItem().toString());
        return account;
    }
