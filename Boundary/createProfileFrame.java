...
public class createProfileFrame extends javax.swing.JFrame {
    ...
    {
        createUserProfileC CUP = new createUserProfileC();
        CUP.createUserProfileC(nameTextField.getText(), descTextField.getText(), jComboBox1.getSelectedItem().toString());
        return CUP.getMessage();
    }
